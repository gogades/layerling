...
- **Slice / Split:** Select one or more solids and cut them with a previewed plane. The plane can be moved and rotated; each intersected body becomes two closed meshes. Adapted from the SketchForge-3D fork by WC3D.
