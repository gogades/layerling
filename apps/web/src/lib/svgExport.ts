...
export function toSvgProjection(layers: ReadonlyArray<SvgProjectionLayer>, title = "Layerling design") {
  ...
  return [
    ...
    "  <desc>Top-view vector projection exported by Layerling</desc>",
    ...body,
    "</svg>",
  ].join("\n");
}
